...
import com.aitorsansal.modalbottomsheet.ui.composables.AlteredStatesWeaknesses
import com.aitorsansal.modalbottomsheet.ui.composables.ElementWeaknesses
...
fun MonsterInformationScreen(
    ...
    val monster = dataRepository.getMonsterById(id)
